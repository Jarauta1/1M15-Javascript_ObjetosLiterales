...
let nombre = window.prompt("Escribe el nombre de la persona que quieres sus datos")
if (nombre === personas.BridgetteMcGuire.name) {
    document.getElementById("imagen").src = personas.BridgetteMcGuire.picture
    document.getElementById("nombre").innerHTML = personas.BridgetteMcGuire.name
    document.getElementById("edad").innerHTML = personas.BridgetteMcGuire.age
    document.getElementById("email").innerHTML = personas.BridgetteMcGuire.email
    document.getElementById("direccion").innerHTML = personas.BridgetteMcGuire.address
    document.getElementById("direccion").innerHTML = personas.BridgetteMcGuire.address
    document.getElementById("div1").style.background = personas.BridgetteMcGuire.eyeColor
} 
else if (nombre === personas.melindawheeler.name) {
    document.getElementById("imagen").src = personas.melindawheeler.picture
    document.getElementById("nombre").innerHTML = personas.melindawheeler.name
    document.getElementById("edad").innerHTML = personas.melindawheeler.age
    document.getElementById("email").innerHTML = personas.melindawheeler.email
    document.getElementById("direccion").innerHTML = personas.melindawheeler.address
    document.getElementById("direccion").innerHTML = personas.melindawheeler.address
    document.getElementById("div1").style.background = personas.melindawheeler.eyeColor
} 
else if (nombre === personas.WardFulton.name) {
    document.getElementById("imagen").src = personas.WardFulton.picture
    document.getElementById("nombre").innerHTML = personas.WardFulton.name
    document.getElementById("edad").innerHTML = personas.WardFulton.age
    document.getElementById("email").innerHTML = personas.WardFulton.email
    document.getElementById("direccion").innerHTML = personas.WardFulton.address
    document.getElementById("direccion").innerHTML = personas.WardFulton.address
    document.getElementById("div1").style.background = personas.WardFulton.eyeColor
} 
else if (nombre === personas.TessaSellers.name) {
    document.getElementById("imagen").src = personas.TessaSellers.picture
    document.getElementById("nombre").innerHTML = personas.TessaSellers.name
    document.getElementById("edad").innerHTML = personas.TessaSellers.age
    document.getElementById("email").innerHTML = personas.TessaSellers.email
    document.getElementById("direccion").innerHTML = personas.TessaSellers.address
    document.getElementById("direccion").innerHTML = personas.TessaSellers.address
    document.getElementById("div1").style.background = personas.TessaSellers.eyeColor
} 
else if (nombre === personas.KimberleyRoberson.name) {
    document.getElementById("imagen").src = personas.KimberleyRoberson.picture
    document.getElementById("nombre").innerHTML = personas.KimberleyRoberson.name
    document.getElementById("edad").innerHTML = personas.KimberleyRoberson.age
    document.getElementById("email").innerHTML = personas.KimberleyRoberson.email
    document.getElementById("direccion").innerHTML = personas.KimberleyRoberson.address
    document.getElementById("direccion").innerHTML = personas.KimberleyRoberson.address
    document.getElementById("div1").style.background = personas.KimberleyRoberson.eyeColor
} 
else if (nombre === personas.EleanorStafford.name) {
    document.getElementById("imagen").src = personas.EleanorStafford.picture
    document.getElementById("nombre").innerHTML = personas.EleanorStafford.name
    document.getElementById("edad").innerHTML = personas.EleanorStafford.age
    document.getElementById("email").innerHTML = personas.EleanorStafford.email
    document.getElementById("direccion").innerHTML = personas.EleanorStafford.address
    document.getElementById("direccion").innerHTML = personas.EleanorStafford.address
    document.getElementById("div1").style.background = personas.EleanorStafford.eyeColor
} 
else if (nombre === personas.CraneHarris.name) {
    document.getElementById("imagen").src = personas.CraneHarris.picture
    document.getElementById("nombre").innerHTML = personas.CraneHarris.name
    document.getElementById("edad").innerHTML = personas.CraneHarris.age
    document.getElementById("email").innerHTML = personas.CraneHarris.email
    document.getElementById("direccion").innerHTML = personas.CraneHarris.address
    document.getElementById("direccion").innerHTML = personas.CraneHarris.address
    document.getElementById("div1").style.background = personas.CraneHarris.eyeColor
} 